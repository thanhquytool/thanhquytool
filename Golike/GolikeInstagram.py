...
def INSTAGRAM():
    ...
    for data in checkurl1_2['data'] :
        ...
        STT.append(i)
        STATUS.append(Fore.GREEN+"Đang Hoạt Động"+Fore.RED)
        account.append(usernametk)
        print(f'\033[1;36m[{i}] \033[1;97mTài Khoản :\033[1;93m {usernametk} :\033[1;93m {STATUS[-1]}')
       
        i += 1
    print('\033[97m══════════════════════════════════════════════════════════════')
    choose = int(input('\033[1;31;40m[\033[1;33;40m«\033[1;37;40m/\033[1;33;40m»\033[1;31;40m] \033[1;37;40m> \033[1;36mNhập Tài Khoản: \033[1;31m'))
    ...
    if choose >=1 or choose <= len(user_INS) :
        ...
        checkfile2 = os.path.isfile('CookieInstagram'+str(account_id)+'.txt')
        if checkfile2 == False:
            banner()
            CookieInstagram = input(Fore.GREEN+'\033[1;31;40m[\033[1;33;40m«\033[1;37;40m/\033[1;33;40m»\033[1;31;40m] \033[1;37;40m> \033[1;36mNhập Cookie Instagram: \033[1;31m')
            createfile = open('CookieInstagram'+str(account_id)+'.txt','w')
            createfile.write(CookieInstagram)
            createfile.close()
            readfile = open('CookieInstagram'+str(account_id)+'.txt','r')
            CookieInstagram = readfile.read()
            readfile.close()
        else:
            readfile = open('CookieInstagram'+str(account_id)+'.txt','r')
            CookieInstagram = readfile.read()
        ...
        os.system('cls' if os.name== 'nt' else 'clear')
        banner()
        choose = int(input(Fore.RED+'\033[1;31;40m[\033[1;33;40m«\033[1;37;40m/\033[1;33;40m»\033[1;31;40m] \033[1;37;40m> \033[1;36mNhập Số Lượng Job: \033[1;31m'))
        headerINS = {
                'accept': '*/*',
                'accept-language': 'vi,en-US;q=0.9,en;q=0.8',
                # 'content-length': '0',
                'content-type': 'application/x-www-form-urlencoded',
                'cookie': CookieInstagram,
                ...
                'x-asbd-id': '129477',
                'x-csrftoken': CookieInstagram.split('csrftoken=')[1].split(';')[0],
        ...
        DELAY = int(input(Fore.RED+'\033[1;31;40m[\033[1;33;40m«\033[1;37;40m/\033[1;33;40m»\033[1;31;40m] \033[1;37;40m> \033[1;36mNhập Delay: \033[1;31m'))
        os.system('cls' if os.name== 'nt' else 'clear')
        banner()
                    ...
                    if job_type == 'follow':
                        ...
                        if '"status":"ok"' in response:
                            ...
                            if response.get('success') == True:
                                ...
                                chuoi = (
                                    f"\033[1;36m{dem}\033[1;31m\033[1;97m ● "
                            ...
                            print(Fore.RED + "Tài Khoản Bị Nhã Follow - Vui Lòng Đổi Acc")
                        elif '"status":"fail"' in response and '"require_login":true' in response:
                            print('Cookie Die Rồi - Vui Lòng Nhập Cookie Mới Hoặc Đổi Acc Khác')
                            os.remove(f'CookieInstagram{account_id}.txt')
                            return 0
                        ...
                        if '"status":"ok"' in response:
                            ...
                            if response['success']==True:
                                ...
                                chuoi = (
                                    f"\033[1;36m{dem}\033[1;31\033[1;97m ● "
                                    f"\033[1;33m{h}:{m}:{s}\033[1;31m\033[1;97m  ● "
                                    f"\033[1;32mSuccess\033[1;31m\033[1;97m ● "
                            ...
                            print(Fore.RED + "Tài Khoản Bị Chặn Like - Vui Lòng Đổi Acc")
                        elif '"status":"fail"' in response and '"require_login":true' in response:
                            print('Cookie Die Rồi - Vui Lòng Nhập Cookie Mới & Đổi Acc Khác')
                            os.remove(f'CookieInstagram{account_id}.txt')
                            return 0
                        # pass
...
if checkfile == False:
    AUTHUR = input(Fore.GREEN+'\033[1;32m>\033[1;33m>\033[1;31m> \033[1;36mAuthorization Golike: \033[1;31m')
...
print(Fore.GREEN+'\033[1;97m[\033[1;91m𝓕𝓠\033[1;97m] \033[1;32mTài Khoản : '+Fore.YELLOW+username)
if checkurl1['status']== 200 :
    ...
    print(Fore.RED+'Đăng Nhập Thất Bại - Vui Lòng Nhập Authorization Lại!')
    os.remove('user.txt')