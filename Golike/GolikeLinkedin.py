...
def LINKEDIN():
    ...
    for data in checkaccount['data']:
        ...
        STT.append(i)
        STATUS.append(Fore.GREEN + "Đang Hoạt Động" + Fore.RESET)
    ...
    if choose >=1 or choose <= len(user_linkedin1) :
        ...
        checkfile = os.path.isfile('CookieLinkedinedin'+str(account_id)+'.txt')
        if checkfile == False:
            banner()
            CookieLinkedin = input(Fore.GREEN+'\033[1;31;40m[\033[1;33;40m«\033[1;37;40m/\033[1;33;40m»\033[1;31;40m] \033[1;37;40m> \033[1;36mNhập Cookie Linkedin: \033[1;31m')
            createfile = open('CookieLinkedinedin'+str(account_id)+'.txt','w')
            createfile.write(CookieLinkedin)
            createfile.close()
            readfile = open('CookieLinkedinedin'+str(account_id)+'.txt','r')
            CookieLinkedin = readfile.read()
            readfile.close()
        else:
            readfile = open('CookieLinkedinedin'+str(account_id)+'.txt','r')
            CookieLinkedin = readfile.read()
                ...
                if checkurl2['status'] ==200:
                    ...
                    if type == 'follow':
                        ...
                        if 'li:fsd_company' not in response and 'identityDashProfilesByMemberIdentity&quot;:{&quot;*elements&quot;:[&quot;urn:li:fsd_profile:' not in response:
                            ...
                            try:
                                crft =  CookieLinkedin.split('JSESSIONID="')[1].split('"')[0],
                                try:
                                    headersX = {
                                    ...
                                    'cookie': CookieLinkedin,
                                    'csrf-token': CookieLinkedin.split('JSESSIONID="')[1].split('"')[0],
                                    ...
                                    f"\033[1;33m{tong} VNĐ"
                                        ...
                                        print('COOKIE DIE')
                                        os.remove('CookieLinkedinedin'+str(account_id)+'.txt')
                                        return 0
                            except IndexError:
                                try:
                                    headersX = {
...
\033[1;37m══════════════════════════════════════════════════════════════
\033[1;97m[\033[1;91m📝\033[1;97m]\033[1;97m Tool\033[1;31m     : \033[1;31m☞ Golike Linkedin🧸 ☜
