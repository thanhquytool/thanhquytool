...
def THREADS():
    ...
    if choose >=1 or choose <= len(user_THREADS) :
        ...
        checkfile2 = os.path.isfile('CookieThreads'+str(account_id)+'.txt')
        if checkfile2 == False:
            banner()
            CookieThreads = input(Fore.GREEN+'\033[1;31;40m[\033[1;33;40m«\033[1;37;40m/\033[1;33;40m»\033[1;31;40m] \033[1;37;40m> \033[1;36mNhập Cookie Threads: \033[1;31m')
            createfile = open('CookieThreads'+str(account_id)+'.txt','w')
            createfile.write(CookieThreads)
            createfile.close()
            readfile = open('CookieThreads'+str(account_id)+'.txt','r')
            CookieThreads = readfile.read()
            readfile.close()
        else:
            readfile = open('CookieThreads'+str(account_id)+'.txt','r')
            CookieThreads = readfile.read()
        ...
        for i in range(choose):
            try:
                headersTHR = {
                    ...
                    'x-asbd-id': '129477',
                    'x-csrftoken': CookieThreads.split('csrftoken=')[1].split(';')[0],
                ...
                if nos['status'] ==200:
                    ...
                    if type == 'follow':
                        try :
                            ...
                            print('Cookie Die Rồi - Vui Lòng Nhập Cookie Mới') 
                            os.remove('CookieThreads'+str(account_id)+'.txt')
                            return 0 
                    elif type == 'like':
                        try :
...
\033[1;37m══════════════════════════════════════════════════════════════
\033[1;97m[\033[1;91m📝\033[1;97m]\033[1;97m Tool\033[1;31m     : \033[1;31m☞ Golike Threads🧸 ☜
...
if checkurl1['status']== 200 :
        ...
        print("\033[1;32mNhập \033[1;37m[\033[1;33m1\033[1;37m] \033[1;32mĐể Vào Tool Threads")
