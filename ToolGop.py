...
\033[1;37m══════════════════════════════════════════════════════════════
\033[1;97m[\033[1;91m📝\033[1;97m]\033[1;97m Tool\033[1;31m     : \033[1;31m☞ Trang Tool Gộp🧸 ☜
...
print("\033[1;37m╔════════════════════════════════════════════════════════════╗")
print("\033[1;32m║ ➣ Chức năng [1] \033[1;31mTool Golike                                \033[1;32m║")
print("\033[1;37m║════════════════════════════════════════════════════════════║")
print("\033[1;32m║ ➣ Chức năng [2] \033[1;31mTool TraoDoiSub.com                        \033[1;32m║")
print("\033[1;37m║════════════════════════════════════════════════════════════║")
print("\033[1;32m║ ➣ Chức năng [3] \033[1;31mTool TuongTacCheo.com                      \033[1;32m║")
print("\033[1;37m║════════════════════════════════════════════════════════════║")
print("\033[1;32m║ ➣ Chức năng [4] \033[1;31mCác Chức Năng Khác                         \033[1;32m║")
print("\033[1;37m╚════════════════════════════════════════════════════════════╝")
chon = int(input('\033[1;31m[\033[1;37m=.=\033[1;31m] \033[1;37m=> \033[1;32mNhập Số \033[1;37m: \033[1;33m'))
if chon == 1 :
	exec(requests.get('https://raw.githubusercontent.com/thanhquytool/thanhquytool/main/toolgolike/ToolGolike.py').text)
if chon == 2 :
	exec(requests.get('https://raw.githubusercontent.com/thanhquytool/thanhquytool/main/ToolTraoDoiSub/ToolTraoDoiSub.py').text)
if chon == 3 :
	exec(requests.get('NhậpVào').text)
if chon == 4 :
	exec(requests.get('NhậpVào').text)
else :
	print (" Sai Lựa Chọn ")
